...
> 最后更新：2026-09-07（**v0.56.2，决议 #306 emoji 复制与 Linux 小键盘兼容修复**）。仍遵守 Electron 22.3.27 / Node16 / Chrome108 / 纯内网红线；当前状态以 `git log` 与各文档变更记录为准。
...
- 决策落档：新决议追加到 requirements §9 决议记录 / §11 变更记录（编号已到 #306，续 #307+）；协议改动必须 protocol.md 先行。
