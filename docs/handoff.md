...
> 最后更新：2026-09-05（**v0.54.9，决议 #299 缩略图并发约束；第二批 OPT-26–28 完成**）。仍遵守 Electron 22.3.27 / Node16 / Chrome108 / 纯内网红线；当前状态以 `git log` 与各文档变更记录为准。
...
- 决策落档：新决议追加到 requirements §9 决议记录 / §11 变更记录（编号已到 #299，续 #300+）；协议改动必须 protocol.md 先行。
