...
Last updated: 2026-09-05 for **v0.54.11** (decision #301, list metadata contrast; OPT-29 complete). The application remains pinned to Electron 22.3.27, Node 16.17 main/preload, Chrome 108 renderer, and LAN-only runtime behavior.
...
| Area | State |
|---|---|
| Version | 0.54.11 list metadata contrast (decision #301) |
